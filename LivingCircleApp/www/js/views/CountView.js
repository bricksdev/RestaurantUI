...
define([ 'jquery', 'underscore', 'Backbone', './CountView', './HomeView','./ServiceView','./UserinfoView',
		"../models/Session", 'text!../../templates/CountView.html' ], 
		function($, _, Backbone,CountView, HomeView, ServiceView,UserinfoView,  Session, CountTemplate) {
